...
export default function InventarioAlimentosAdicion() {
    return (
        <div>
                    ...
                    <Link to="/inventario/gallinas" className="enlace-sin-decorado">
                        <div className="tarjeta-registro">
                            ...
                            <div className="tarjeta-registro__contenedor-informacion">
                                <p className="tarjeta-registro__informacion tarjeta-registro__informacion--resaltada">Cantidad añadida (Kg): 1</p>
