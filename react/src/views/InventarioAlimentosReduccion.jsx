...
export default function InventarioAlimentosReduccion() {
    return (
        <div>
                ...
                <div className="contenedor-tarjeta">
                    <Link to="/inventario/gallinas" className="enlace-sin-decorado">
                        <div className="tarjeta-registro">
                            <h3 className="tarjeta-registro__titulo">Maiz</h3>
                            <div className="tarjeta-registro__contenedor-informacion">
                                <p className="tarjeta-registro__informacion tarjeta-registro__informacion--resaltada">Cantidad reducida (Kg): 0.5</p>
                                <p className="tarjeta-registro__informacion tarjeta-registro__informacion--resaltada">Razón de reducción: Consumida por las gallinas</p>
