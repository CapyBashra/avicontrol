...
export default function SaludVacunacion() {
                ...
                <div className="contenedor-tarjeta">
                    <Link to="/inventario/gallinas" className="enlace-sin-decorado">
                        <div className="tarjeta-registro">
                            <h3 className="tarjeta-registro__titulo">Newcastle</h3>
                            <div className="tarjeta-registro__contenedor-informacion">
                                <p className="tarjeta-registro__informacion tarjeta-registro__informacion--resaltada">Rango: Todo el galpón</p>
                                <p className="tarjeta-registro__informacion tarjeta-registro__informacion--resaltada">Vacuna: Breedervac 8</p>
                                <p className="tarjeta-registro__informacion tarjeta-registro__informacion--resaltada">Cantidad vacunada: 140</p>
